...
//         fetch(`https://backend-carshop.onrender.com/api/buyer-addresses/${user.email}`),
//         fetch(`https://backend-carshop.onrender.com/api/payments/${user.email}`, {
//           headers: {
...
//       const orderResponse = await fetch('https://backend-carshop.onrender.com/api/orders', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//           Authorization: `Bearer ${token}`,
...
//       const cartResponse = await fetch(`https://backend-carshop.onrender.com/api/carts/${userEmail}`, {
...
//         await fetch('https://backend-carshop.onrender.com/api/shipments', {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
//             Authorization: `Bearer ${token}`,
...
//       await fetch(`https://backend-carshop.onrender.com/api/carts/clear/${userEmail}`, {
//         method: 'DELETE',
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//       const buyerResponse = await fetch(`https://backend-carshop.onrender.com/api/buyer/getPreferences/${userEmail}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
